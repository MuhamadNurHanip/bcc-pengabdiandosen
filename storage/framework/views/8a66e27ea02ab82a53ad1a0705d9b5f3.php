                                ...
                                <div class="relative h-56 overflow-hidden rounded-lg md:h-96">
                                    ...
                                    <?php if($produk->image1): ?>
                                        <div class="hidden duration-700 ease-in-out" data-carousel-item>
                                            <img src="<?php echo e(asset('upload/produk/' . $produk->image1)); ?>"
                                    ...
                                    <?php if($produk->image2): ?>
                                        <div class="hidden duration-700 ease-in-out" data-carousel-item>
                                            <img src="<?php echo e(asset('upload/produk/' . $produk->image2)); ?>"
                                                class="absolute block w-full -translate-x-1/2 -translate-y-1/2 top-1/2 left-1/2"
                                                alt="...">
                                        </div>
                                    <?php endif; ?>
                                    ...
                                    <?php if($produk->image3): ?>
                                        <div class="hidden duration-700 ease-in-out" data-carousel-item>
                                            <img src="<?php echo e(asset('upload/produk/' . $produk->image3)); ?>"
                                                class="absolute block w-full -translate-x-1/2 -translate-y-1/2 top-1/2 left-1/2"
                                                alt="...">
                                        </div>
                                    <?php endif; ?>
                                    ...
                                    <?php if($produk->image4): ?>
                                        <div class="hidden duration-700 ease-in-out" data-carousel-item>
                                            <img src="<?php echo e(asset('upload/produk/' . $produk->image4)); ?>"
                                                class="absolute block w-full -translate-x-1/2 -translate-y-1/2 top-1/2 left-1/2"
                                                alt="...">
                                        </div>
                                    <?php endif; ?>
                                    ...
                                    <li>
                                        <a href="<?php echo e($kontak->tautan); ?>" class="hover:underline">
                                            <label for="job-1"
                                                ...
                                                <img src="<?php echo e(asset('images/' . $kontak->gambar)); ?>"
