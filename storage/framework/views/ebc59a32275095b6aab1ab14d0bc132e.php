        ...
        <div class="bg-white dark:bg-gray-800 relative shadow-md sm:rounded-lg">
            <div class="flex flex-col md:flex-row items-center justify-between space-y-3 md:space-y-0 p-4">
                ...
                <div class="w-full md:w-auto flex flex-col md:flex-row space-y-2 md:space-y-0 items-stretch md:items-center justify-end md:space-x-3 flex-shrink-0">
                    <a href="<?php echo e(route('kerjasama.create')); ?>" class="flex items-center justify-center text-white bg-amber-500 hover:bg-amber-400 focus:ring-4 focus:ring-primary-300 font-medium rounded-lg text-sm px-4 py-2 dark:bg-primary-600 dark:hover:bg-primary-700 focus:outline-none dark:focus:ring-primary-800">
                ...
                <table class="w-full text-sm text-left text-gray-500 dark:text-gray-400">
                    ...
                    <tbody>
                        ...
                        <tr class="border-b dark:border-gray-700">
                            ...
                            <td class="px-4 py-3">
                                <img src="<?php echo e(asset('images/' . $kerjasama->gambar)); ?>" alt="Product Image" class="w-16 md:w-24">
                            </td>
                            <td class="px-4 py-3 flex items-center">
                                ...
                                <div id="actionsDropdown-<?php echo e($kerjasama->id); ?>" class="hidden z-10 w-44 bg-white rounded divide-y divide-gray-100 shadow dark:bg-gray-700 dark:divide-gray-600">
                                    <ul class="py-1 text-sm text-gray-700 dark:text-gray-200" aria-labelledby="actionsDropdownButton-<?php echo e($kerjasama->id); ?>">
                                        <li>
                                            <a href="<?php echo e(route('kerjasama.edit', $kerjasama->id)); ?>" class="block py-2 px-4 hover:bg-gray-100 dark:hover:bg-gray-600 dark:hover:text-white">Edit</a>
                                        </li>
                                    </ul>
                                    <div class="py-1">
                                        <form action=" <?php echo e(route('kerjasama.destroy', $kerjasama->id)); ?>" method="POST" onsubmit="return confirm('Apakah anda yakin ingin menghapus kerjasama ini?');">
                                            <?php echo csrf_field(); ?>
            ...
            <nav class="flex flex-col md:flex-row justify-between items-start md:items-center space-y-3 md:space-y-0 p-4"
                ...
                <span class="text-sm font-normal text-gray-500 dark:text-gray-400">
                    ...
                    <span class="font-semibold text-gray-900 dark:text-white">
                        <?php if($kerjasamas->count()): ?>
                            <?php echo e($kerjasamas->firstItem()); ?>-<?php echo e($kerjasamas->lastItem()); ?>
                    ...
                    dari
                    <span class="font-semibold text-gray-900 dark:text-white"><?php echo e($kerjasamas->total()); ?></span>
                </span>

                <!-- Dynamic Pagination Links -->
                <div>
                    <?php echo e($kerjasamas->links()); ?> <!-- Menampilkan link navigasi halaman -->
                </div>
            </nav>
        </div>
...
<?php endif; ?>
<?php /**PATH C:\Users\lenovo\Downloads\test\bcc-pengabdiandosen\resources\views\kerjasama\index.blade.php ENDPATH**/ ?>