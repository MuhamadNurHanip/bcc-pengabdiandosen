    ...
    <!-- include summernote css/js -->
        ...
        <form action="<?php echo e(route('Artikel.update', $artikel->id)); ?>" method="POST" enctype="multipart/form-data">
            ...
            <div class="mb-4">
                ...
                <img src="<?php echo e(asset('upload/artikel/' . $artikel->gambar)); ?>" alt="Artikel Image" class="mt-2 w-[300px]" width="450" height="450">
            </div>
...
<?php endif; ?>
<?php /**PATH C:\Users\lenovo\Downloads\test\bcc-pengabdiandosen\resources\views\Artikel\edit.blade.php ENDPATH**/ ?>