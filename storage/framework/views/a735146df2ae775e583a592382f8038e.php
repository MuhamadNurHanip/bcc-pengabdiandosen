        ...
        <nav class="flex" aria-label="Breadcrumb">
            ...
            <form action="<?php echo e(route('kontak.update', $kontak->id)); ?>" method="POST" enctype="multipart/form-data">
                ...
                <div class="mb-4">
                    ...
                    <img src="<?php echo e(asset('images/' . $kontak->gambar)); ?>" alt="Produk Image" class="mt-2 w-36 h-36">
                </div>
...
<?php endif; ?>
<?php /**PATH C:\Users\lenovo\Downloads\test\bcc-pengabdiandosen\resources\views\kontak\edit.blade.php ENDPATH**/ ?>