    ...
    <section class="container mx-auto px-10 py-0">
        <div class="flex justify-center py-5">
            <div
                        ...
                        <li>
                            <div class="flex items-center">
                                ...
                                <a href="#"
                                    ...
                                    <?php echo e($locale !== 'id' ? $artikel->judul_translated : $artikel->judul); ?></a>
                            </div>
                        </li>
                    </ol>
                </nav>
                ...
                <!-- Title -->
                <h3 class="text-3xl font-extrabold text-gray-900 mb-3"><?php echo e($locale !== 'id' ? $artikel->judul_translated : $artikel->judul); ?></h3>

                <!-- Publish Date -->
                <p class="mb-3 text-gray-500">
                    <?php echo e(\Carbon\Carbon::parse($artikel->tgl_published)->locale($locale)->isoFormat('dddd, D MMMM YYYY')); ?>
                ...
                <div
                    ...
                    <img src="<?php echo e(asset('upload/artikel/' . $artikel->gambar)); ?>"
                ...
                <div class="c-blog-detail-body py-3">
                    <p class="font-serif">
                        <?php echo $artikel->konten_translated ?? $artikel->konten; ?>
...
<?php echo $__env->make('layout.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\lenovo\Downloads\test\bcc-pengabdiandosen\resources\views\detailArtikel.blade.php ENDPATH**/ ?>